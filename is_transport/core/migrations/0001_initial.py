# Generated by Django 6.0 on 2026-01-24 23:26
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('montant_HT', models.DecimalField(decimal_places=2, default=0, editable=False, max_digits=10)),
                ('montant_TVA', models.DecimalField(decimal_places=2, default=0, editable=False, max_digits=10)),
                ('montant_TTC', models.DecimalField(decimal_places=2, default=0, editable=False, max_digits=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type_incident', models.CharField(choices=[('retard', 'Retard'), ('perte', 'Perte'), ('endommagement', 'Endommagement'), ('probleme_technique', 'Problème technique')], max_length=30)),
